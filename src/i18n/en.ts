const en = {
  ...
  panel: {
    ...
    buy: "Add",
    coachCTASub: "Get personalized advice",
    sell: "Remove",
    ask: "Ask",
    detail: "Detail",
    riskLabel: "Risk",
  ...
  multiplayer: {
    ...
    enterCode: "Room code",
    back: "Back",
    roomNotFound: "Room not found. Double-check the code and try again.",
    roomFull: "This room is full (4/4 players). Ask the host to create a new one.",
    ...
    impactGood: "📈 Good for your portfolio",
    impactBad: "📉 Bad for your portfolio",
    impactMild: "➡️ Mild effect on your portfolio",
    eventTipPositive: "💡 Tip: Buying or holding could benefit you here.",
    eventTipNegative: "💡 Tip: Selling limits your losses here.",
    buyButtonLabel: "Buy (+CHF 100)",
    buyButtonHint: "invest more",
    gameOver: "Game Over!",
    wins: "wins",
    winsWithLoss: "survives best! 🏆 — sometimes the goal is to lose less.",
    winWithLoss: "The goal: outlast everyone. You lost the least — that's investing.",
    you: "you",
