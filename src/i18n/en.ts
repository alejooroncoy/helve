const en = {
  ...
  // Multiplayer
  multiplayer: {
    subtitle: "Compete with friends! Build portfolios and survive market storms together.",
    ...
    pickAssets: "Build Your Nest",
    pickAssetsDesc: "Pick up to {{max}} investments for your portfolio",
    ready: "Ready!",
