const en = {
  ...
  panel: {
    ...
    nestFull: "Your nest is full! Sell an egg to make room.",
    riskyBuy: "Careful! You bought something risky. Your nest shakes a bit...",
    safeBuy: "Good buy! A very safe egg for your nest.",
    normalBuy: "Bought! Good eye, that egg looks promising.",
    soldMsg: "Sold {{name}}! Sometimes letting go of an egg is the best decision.",
    soldGeneric: "Egg sold. Your nest feels lighter.",
