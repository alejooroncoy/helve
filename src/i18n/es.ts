const es = {
  ...
  panel: {
    ...
    nestFull: "¡Tu nido está lleno! Quita un huevo para hacer espacio.",
    riskyBuy: "¡Agregado! Cuidado, este es arriesgado. Tu nido tiembla un poco...",
    safeBuy: "¡Agregado! Un huevito muy seguro para tu nido.",
  ...
  // Multiplayer
  multiplayer: {
    subtitle: "¡Compite con amigos! Arma portafolios y sobrevive tormentas del mercado juntos.",
    ...
    scanQR: "O escanea para unirte",
    players: "Jugadores",
    waitingPlayer: "Esperando...",
    startGame: "Iniciar juego",
    needPlayers: "Se necesitan 2+ jugadores",
    waitingHost: "Esperando a que el host inicie...",
    pickAssets: "Arma tu Nest",
    pickAssetsDesc: "Elige hasta {{max}} inversiones para tu portafolio",
    ready: "¡Listo!",
