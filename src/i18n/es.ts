const es = {
  ...
  panel: {
    ...
    buy: "Agregar",
    coachCTASub: "Recibe consejos personalizados",
    sell: "Quitar",
    ask: "Preguntar",
    detail: "Detalle",
    riskLabel: "Riesgo",
  ...
  timeSim: {
    ...
    nestShrunk: "Tu nido cayó CHF {{amount}} en {{period}}, pero ya entiendes mejor cómo reaccionó.",
    ...
    today: "Hoy",
    goodDecision: "Buena decisión",
    badDecision: "No te preocupes",
    continue: "Continuar",
    from: "desde",
    timeLabels: {
      today: "Hoy",
    ...
    movingSharp: "{{name}} está moviéndose fuerte...",
    dirDrop: "Caída",
    dirSurge: "Subida",
    dirVolatile: "Tensión",
  },
